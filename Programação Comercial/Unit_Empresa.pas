...
begin
    ...
    if(edit_Lucro.value = 0)
      Then Begin
         Application.MessageBox('O Campo de lucro é obrigatorio',
                                'Informe o lucro',
                                MB_ICONERROR+MB_OK);
         Result:= false;
    ...
    if(trim(edit_NomeResponsavel.text) = '')
      Then Begin
         Application.MessageBox('O Campo de nome do responsavel é obrigatorio',
    ...
    if(AnsiPos(' ', edit_telefoneResponsavel.text) <> 0)
      Then Begin
         Application.MessageBox('O Campo de telefone do responsavel é obrigatorio',
