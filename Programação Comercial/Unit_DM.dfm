object DM: TDM
  ...
  object IBDatabase1: TIBDatabase
    DatabaseName = 'C:\Users\godgc\Desktop\Programa'#231#227'o Comercial\DBCOMERCIAL.FDB'
    Params.Strings = (
      'user_name=sysdba'
      'password=masterkey')
    LoginPrompt = False
  ...
  object QryProdutoVenda: TIBQuery
    Database = IBDatabase1
    Transaction = IBTransaction1
    Left = 320
    Top = 112
  ...
  object QryContaReceber: TIBQuery
    Database = IBDatabase1
    Transaction = IBTransaction1
    Left = 232
    Top = 16
  end
  object QryContaPagar: TIBQuery
    Database = IBDatabase1
    Transaction = IBTransaction1
    Left = 232
    Top = 112
